 ...
 *, *:before, *:after {
 ...
 @keyframes animatePath {
  ...
  <div class="demo">
    <div class="login">
     ...
     <button type="submit" class="login__submit">Sign in</button>
        ...
        <p class="login__signup">Don't have an account? &nbsp; <a href="member/join">Sign up</a></p>
      </div>
    </div>
  ...
  $(document).ready(function() {
  	...
  	if (msg=="fail") {
  		alert("아이디 및 패스워드를 확인 부탁드립니다.");
  	}
	if (msg=="logout") {
  		alert("로그아웃 정상처리 되었습니다. 시스템을 종료합니다.");
  	}
