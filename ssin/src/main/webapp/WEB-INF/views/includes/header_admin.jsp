...
%>
	...
	var inspection1 = new Audio('/resources/Sound/inspection1.m4a');
	var inspection2 = new Audio('/resources/Sound/inspection2.m4a');
	var inspection3 = new Audio('/resources/Sound/inspection0.m4a');
  ...
  <body >
	...
	<nav
		...
		<div class="navbar-collapse collapse" id="collapsingNavbar">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link" href="/member/admin">Home
		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-3 col-lg-2 sidebar-offcanvas bg-light pl-0"
				...
				<ul class="nav flex-column sticky-top pl-0 pt-5 mt-3">
					<li class="nav-item"><a class="nav-link" href="/member/admin">Home</a></li>
					<li class="nav-item"><a class="nav-link" href="#submenu1"
						...
						<ul class="list-unstyled flex-column pl-3 collapse" id="submenu2" aria-expanded="false">
							...
							<li class="nav-item"><a class="nav-link" href="/member/admin">점검요청</a></li>
							</ul></li>
				</ul>
			</div>
			<!--/col-->