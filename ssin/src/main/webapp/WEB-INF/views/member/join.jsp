 ...
 *, *:before, *:after {
 ...
 @keyframes animatePath {
  ...
  <div class="demo">
    <div class="login">
    	<h1 class="login__signup" style="text-align: center; padding-top: 10%; font-size: 300%;">회 원 가 입</h1>
      ...
      <form action="join1" method="post">
        <div class="login__row">
          ...
          <input type="text" class="login__input name" placeholder="Username" name="id"/>
        </div>
        <div class="login__row">
       ...
       <div class="login__row">
          <input type="text" class="login__input name" placeholder="name" name="name"/>
        </div>
        <div class="login__row">
          <input type="text" class="login__input name" placeholder="phone" name="phone"/>
        </div>
        <div class="login__row">
          <input type="text" class="login__input name" placeholder="address" name="address"/>
        </div>
        <div class="login__row">
